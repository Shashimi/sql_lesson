...
def make_new_project(title, description, max_grande):
    query = """INSERT INTO Projects (title, description, max_grande) Values (?, ?, ?)"""
    DB.execute(query, (title, description, max_grande))
    CONN.commit()
